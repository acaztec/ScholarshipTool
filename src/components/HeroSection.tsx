        ...
        <div className="hero-content">
          <div className="hero-text">
            <h1 className="hero-title">
              Scholarship <span className="highlight">Search</span>
            </h1>
            <p className="hero-description">
              Find hand-picked, quality scholarships to help pay for school. 
              <a href="#" className="promise-link">Read our promise to you.</a>
            </p>
          </div>
